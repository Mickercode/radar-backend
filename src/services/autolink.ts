...
import { embedText, EMBEDDING_MODEL_NAME } from '../lib/gemini';

// Knowledge-graph auto-linking (PLAYBOOK §4B). Ported from link-insight:
//   1. embed the insight (title+what+why+edge) via Gemini
...
// similarity search use raw SQL. The embedding column is `vector(768)`; pgvector
